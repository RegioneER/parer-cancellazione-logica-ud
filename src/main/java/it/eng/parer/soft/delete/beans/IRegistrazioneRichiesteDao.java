...
public interface IRegistrazioneRichiesteDao {
    ...
    Long getIdRichScartoVersEvasa(BigDecimal idStrut, BigDecimal idRichiestaSacer)
            throws AppGenericPersistenceException;

    boolean existAroRichScartoVers(BigDecimal idStrut, BigDecimal idRichScartoVers)
            throws AppGenericPersistenceException;
    ...
    AroRichSoftDelete getAroRichSoftDeleteContainingRichScartoVers(Long idRichScartoVers,
            Long idRichSoftDelete) throws AppGenericPersistenceException;
    ...
    boolean isUdNonScartata(long idUnitaDoc) throws AppGenericPersistenceException;
