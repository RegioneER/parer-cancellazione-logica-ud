 ...
 *
 */
public class CancellazioneLogicaOauth2MultipartForm implements ICancellazioneLogicaMultipartForm {

    public CancellazioneLogicaOauth2MultipartForm() {
        super();
    }

    @Schema(type = SchemaType.STRING, required = true, example = "1.0", description = "Versione dell'xml versato (versione della request)")
    @FormParam("VERSIONE")
    ...
    public RichiestaCancellazioneLogica richCancellazioneLogica;
