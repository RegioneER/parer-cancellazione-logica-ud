...
public class VrsDatiSessioneVers extends SoftDelete implements Serializable {
    ...
    @OneToMany(mappedBy = "vrsDatiSessioneVers")
    private List<VrsXmlModelloSessioneVers> vrsXmlModelloSessioneVers = new ArrayList<>();
    ...
    public List<VrsXmlModelloSessioneVers> getVrsXmlModelloSessioneVers() {
        return this.vrsXmlModelloSessioneVers;
    }
